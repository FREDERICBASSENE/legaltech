                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
						<div class="menu-logo">
							<a href="index.php"><img src="assets/images/legaltech.jpg" alt=""></a>
						</div>
                        <ul class="nav navbar-nav">	
							<li class="<?= set_active('index')?>"><a href="index.php">Home</a>
								
							</li>
							<li class="<?= set_active('About')?>"><a href="About.php">About us </a>
								
							</li>
							<li class="<?= set_active('contact')?>"><a href="contact.php">Nous contactez </a>
									
							</li>
							<li class="<?= set_active('blog-classic-sidebar')?>"><a href="blog-classic-sidebar.php">Blog </a>
							</li>
					...
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Title   tp-resizeme" 
								...
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;">
									LEGALTECH AU COEUR DE L'INOVATION
							</div>
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:28px; font-weight:400;">
									 NOUS SOMME UN CABINET JURIDIQUE PROCHE DE VOUS
							</div>
							<!-- LAYER NR. 4 -->
							...
							<div class="tp-caption Newspaper-Button rev-btn" 
								...
								data-paddingbottom="[12,12,12,12]"
								data-paddingleft="[30,35,35,15]"
								style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; border-radius:30px;"><a href="contact.php">CONTACTEZ NOUS</a></div>
						</li>
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Button rev-btn " 
								...
								data-paddingbottom="[12,12,12,12]"
								data-paddingleft="[30,35,35,15]"
								style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; background-color:var(--primary) !important; border:0; border-radius:30px; margin-right:5px;">PLUS DE DETAILES </div>
							<div class="tp-caption Newspaper-Button rev-btn" 
